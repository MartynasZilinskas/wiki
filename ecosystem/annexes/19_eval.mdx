...
zi ice lucid wait id-as'z-shell/pyenv-venv' has'pyenv-virtualenv-init' \
  atclone'pyenv virtualenv-init - > init.zsh' \
...
```shell {2} showLineNumbers
zi ice lucid wait id-as'z-shell/pyenv-venv' \
  has'pyenv-virtualenv-init' \
  eval'pyenv virtualenv-init -' nocompile'!'
zi light @z-shell/0
```
